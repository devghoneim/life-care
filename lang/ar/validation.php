...
return [
    ...
    'custom' => [
        'lat' => [
            'regex' => 'قيمة خط العرض غير صحيحة. يجب أن تكون بين -90 و 90 درجة.',
            'required' => 'حقل خط العرض مطلوب.',
            'numeric' => 'يجب أن يكون خط العرض رقمًا.'
        ],
        'lng' => [
            'regex' => 'قيمة خط الطول غير صحيحة. يجب أن تكون بين -180 و 180 درجة.',
            'required' => 'حقل خط الطول مطلوب.',
            'numeric' => 'يجب أن يكون خط الطول رقمًا.'
        ],
        'value' => [
            'min' => 'يجب أن تكون قيمة حقل القيمة على الأقل :min.',
            'numeric' => 'يجب أن يكون حقل القيمة رقمًا.'
        ],
        'min_order_price' => [
            'min' => 'يجب أن تكون قيمة حقل أقل سعر للطلب على الأقل :min.',
            'numeric' => 'يجب أن يكون حقل أقل سعر للطلب رقمًا.'
        ],
        'start_date' => [
            'before' => 'يجب أن يكون حقل تاريخ البداية قبل تاريخ النهاية.',
        ],
        'end_date' => [
            'after' => 'يجب أن يكون حقل تاريخ النهاية بعد تاريخ البداية أو تاريخ اليوم.',
        ],
        'question_en' => [
            'unique' => 'السؤال باللغة الإنجليزية موجود بالفعل.'
        ],
        'question_ar' => [
            'unique' => 'السؤال باللغة العربية موجود بالفعل.'
        ],
        'answer_en' => [
            'unique' => 'الجواب باللغة الإنجليزية موجود بالفعل.'
        ],
        'answer_ar' => [
            'unique' => 'الجواب باللغة العربية موجود بالفعل.'
        ],
        'code' => [
            'unique' => 'الرمز موجود بالفعل.'
        ],
        'status' => [
            'in' => 'حقل الحالة غير صالح.'
        ],
    ],
];
